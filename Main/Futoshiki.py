...
def def_Futoshiki(difficulte, level, la_grille_base, la_grille_finie):
    ...
    def installe_grille():
        ...
        # sont les chiffres de base non modifiable
    ...
    def afficher_indice():
        ...
        if (nombre_case_vide != 0):
            ...
            if (indice == 1):
                pygame.draw.rect(screen, colorindice,
    ...
    colorindice = (0, 255, 0) # couleur quand on prend un indice
    ...
    while running:  # Tant que la fentetre est en cours
        ...
        for event in pygame.event.get():  # Pour chaque evenement
            ...
            if (event.type == MOUSEBUTTONDOWN and clicked and verifie_grille_finie(grille, grille_finie) == False):
                clicked = False
