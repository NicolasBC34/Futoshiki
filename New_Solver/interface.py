...
psp2 = pygame.image.load("Pspé2.png")
...
def affichageN():
    ...
    screen.blit(psp2, (10, 120 + marge_haut))
    screen.blit(p2, (10, 120 + marge_haut))
    screen.blit(psp2, (10, 220 + marge_haut))
    screen.blit(p3, (10, 220 + marge_haut))
    screen.blit(psp2, (10, 320 + marge_haut))
    screen.blit(p4, (10, 320 + marge_haut))
    screen.blit(psp2, (110, 20 + marge_haut))
    screen.blit(f1, (110, 20 + marge_haut))
    screen.blit(psp2, (110, 120 + marge_haut))
    screen.blit(f2, (110, 120 + marge_haut))
    screen.blit(psp2, (110, 220 + marge_haut))
